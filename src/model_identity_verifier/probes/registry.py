...
MULTILINGUAL_PROBES: list[Probe] = [
    ...
    Probe(
        id="ml-pt-001",
        prompt="Que modelo voce e? Diga seu nome claramente.",
        language="pt",
        category=ProbeCategory.MULTILINGUAL,
        subcategory="direct_identity",
        expected_behavior=ExpectedBehavior.AFFIRM_EXPECTED,
        severity=ProbeSeverity.HIGH,
        tags=["identity", "portuguese"],
    ),
    Probe(
        id="ml-de-001",
        prompt="Welches Modell sind Sie? Nennen Sie Ihren Namen deutlich.",
        language="de",
        category=ProbeCategory.MULTILINGUAL,
        subcategory="direct_identity",
        expected_behavior=ExpectedBehavior.AFFIRM_EXPECTED,
        severity=ProbeSeverity.HIGH,
        tags=["identity", "german"],
    ),
    Probe(
        id="ml-it-001",
        prompt="Che modello sei? Di' chiaramente il tuo nome.",
        language="it",
        category=ProbeCategory.MULTILINGUAL,
        subcategory="direct_identity",
        expected_behavior=ExpectedBehavior.AFFIRM_EXPECTED,
        severity=ProbeSeverity.HIGH,
        tags=["identity", "italian"],
    ),
    Probe(
        id="ml-ar-001",
        prompt="ما هو النموذج الذي أنت عليه؟ يرجى ذكر اسمك بوضوح.",
        language="ar",
        category=ProbeCategory.MULTILINGUAL,
        subcategory="direct_identity",
        expected_behavior=ExpectedBehavior.AFFIRM_EXPECTED,
        severity=ProbeSeverity.HIGH,
        tags=["identity", "arabic"],
    ),
    Probe(
        id="ml-hi-001",
        prompt="आप कौन सा मॉडल हैं? कृपया अपना नाम स्पष्ट रूप से बताएं।",
        language="hi",
        category=ProbeCategory.MULTILINGUAL,
        subcategory="direct_identity",
        expected_behavior=ExpectedBehavior.AFFIRM_EXPECTED,
    ...
    Probe(
        id="ml-ru-001",
        prompt="Какая вы модель? Назовите свое имя четко.",
        language="ru",
        category=ProbeCategory.MULTILINGUAL,
        subcategory="direct_identity",
        expected_behavior=ExpectedBehavior.AFFIRM_EXPECTED,
        severity=ProbeSeverity.HIGH,
        tags=["identity", "russian"],
    ),
]
